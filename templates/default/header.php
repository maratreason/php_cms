        ...
        <div class="container">
            <div class="header__wrapper">
                ...
                <div class="header__logo">
                    <a href="index.html"><img src="<?=TEMPLATE?>assets/img/Logo.svg" alt="магазин инженерной сантехники"></a>
                ...
                <div class="header__sidebar">
                    <div class="header__sidebar_btn">
                        <a href="http://somesite.ru/cart/">
                            <svg class="inline-svg-icon svg-basket">
                                <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#basket"></use>
                            </svg>
                        </a>
                    </div>
                    ...
                    <div class="header__sidebar_btn"><a href="index.html#">
                            <svg class="inline-svg-icon svg-instagram">
                                <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#instagram"></use>
                            </svg>
                        </a></div>
                    <div class="header__sidebar_btn"><a href="index.html#">
                            <svg class="inline-svg-icon svg-vk">
                                <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#vk"></use>
                            </svg>
                        </a></div>
                    <div class="header__sidebar_btn"><a href="index.html#">
                            <svg class="inline-svg-icon svg-facebook">
                                <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#facebook"></use>
                            </svg>
                        </a></div>
                </div>
