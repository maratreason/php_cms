            ...
            <div class="catalog-internal-wrap">
                ...
                <?php else: ?>
                    <aside class="catalog-aside">
                        <?php if (!empty($catalog['filters']) || !empty($catalog['prices'])): ?>
                                                    ...
                                                    <div class="catalog-range-slider">
                                                        <div class="catalog-filter-range__inputs">
                                                            ...
                                                            <div class="catalog-filter-range__limit">
                                                                ...
                                                                <input name="max_price" value="<?=$catalogPrices['max_price']?>" type="text" class="catalog-filter-range__input js-rangeSliderMaximal">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <section class="catalog-section catalog-section__four">
                        ...
                        <div class="catalog-section-pagination">
                            ...
                            <a href="catalog.html#" class="catalog-section-pagination__item">1</a>
                            <a href="catalog.html#" class="catalog-section-pagination__item">2</a>
                            <a href="catalog.html#" class="catalog-section-pagination__item">3</a>
                            <a href="catalog.html#" class="catalog-section-pagination__item">4</a>
                            <a href="catalog.html#" class="catalog-section-pagination__item">5</a>
