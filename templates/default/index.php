<section class="slider">
            ...
            <div class="slider__item-description">
              ...
              <div class="slider__item-logos">
                <div class="slider__item-15yrs">
                  <img src="<?=TEMPLATE?>assets/img/slider/15.svg" alt="">
                  <p><span>Лет</span>на рынке</p>
                </div>
              </div>
            </div>
            <div class="slider__item-image">
              <img src="<?=TEMPLATE?>assets/img/slider/slide1.png" alt="">
            </div>
          </div>
      ...
      <div class="slider__pagination swiper-pagination"></div>
        <div class="slider__controls controls _prev swiper-button-prev">
          <svg>
            <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#arrow"></use>
          </svg>
        </div>
      ...
      <div class="division-internal__items">
        ...
        <a href="division-internal.html#" class="division-internal-item">
          ...
          <span class="division-internal-item__arrow-stat">
            <svg>
              <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#arrow-right"></use>
            </svg>
          </span>
          <span class="division-internal-item__arrow">
            <img src="<?=TEMPLATE?>assets/img/divisions/devision-arrow.png" alt="">
          </span>
        </a>
        ...
        <ul class="offers__tabs_header">
          <li class="active">
            <div class="icon-offer"><svg>
                <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#hit"></use>
              </svg></div>Хиты продаж
          </li>
          <li>
            <div class="icon-offer">
              <svg>
                <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#hot"></use>
              </svg>
            </div>
            Горячие предложения
          </li>
            ...
            <div class="offers__tabs_wrapper swiper-wrapper">
              ...
              <div class="offers__tabs_card swiper-slide">
                <div class="offers__tabs_image">
                  <img src="<?=TEMPLATE?>assets/img/offers.png" alt="">
                </div>
      ...
      <div class="horizontal__wrapper">
        <section class="about">
          ...
          <div class="about__image">
            <img src="<?=TEMPLATE?>assets/img/about.png" alt="">
          </div>
        </section>
          ...
          <div class="advantages__wrapper">
            <div class="advantages__row advantages__row_left">
              <div class="advantages__item">
                ...
                <img src="<?=TEMPLATE?>assets/img/advantages/adv1.png" class="advantages__item_image" alt="">
              </div>
              <div class="advantages__item">
                <div class="advantages__item_header">Комплексный подход</div>
                <img src="<?=TEMPLATE?>assets/img/advantages/adv2.png" class="advantages__item_image" alt="">
              </div>
              <div class="advantages__item">
                <div class="advantages__item_header">Квалифицированные сотрудники</div>
                <img src="<?=TEMPLATE?>assets/img/advantages/adv3.png" class="advantages__item_image" alt="">
              </div>
            </div>
            <div class="advantages__row advantages__row_right">
              <div class="advantages__item">
                ...
                <div class="advantages__item_image">
                  <img src="<?=TEMPLATE?>assets/img/advantages/adv4.png" alt="" class="advantages__item_image">
                </div>
              </div>
              <div class="advantages__item">
                <div class="advantages__item_header">Работаем со всеми современными системами</div>
                <div class="advantages__item_image">
                  <img src="<?=TEMPLATE?>assets/img/advantages/adv5.png" alt="" class="advantages__item_image">
                </div>
              </div>
              <div class="advantages__item">
                <div class="advantages__item_header">Гарантия качества</div>
                <div class="advantages__item_image">
                  <img src="<?=TEMPLATE?>assets/img/advantages/adv6.png" alt="" class="advantages__item_image">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="search ">
      <button>
        <svg class="inline-svg-icon svg-search">
          <use xlink:href="<?=TEMPLATE?>assets/img/icons.svg#search"></use>
        </svg>
      </button>
